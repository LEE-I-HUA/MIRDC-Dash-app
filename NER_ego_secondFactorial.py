...
X = pd.read_csv('./NER_analysis_data/NER_old/doc_raw_data.csv')

XX_Sent = pd.read_csv('./NER_analysis_data/SenDTM.csv')
XX_Doc = pd.read_csv('./NER_analysis_data/DocDTM.csv')
senlabel = pd.read_csv('./NER_analysis_data/NER_old/sen_label_table.csv')
raw_S = pd.read_csv('./NER_analysis_data/NER_old/sen_raw_data.csv')
CR_doc = pd.read_csv('./NER_analysis_data/DocCR.csv')
CR_sen = pd.read_csv('./NER_analysis_data/SenCR.csv')
CO_doc = pd.read_csv('./NER_analysis_data/DocCO.csv')
CO_sen = pd.read_csv('./NER_analysis_data/SenCO.csv')
